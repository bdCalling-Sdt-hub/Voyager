...
const MySubscription = ({navigation}: any) => {
  return (
    <View>
      <View style={tw`bg-gray80 p-4 rounded-2xl`}>
        <View style={tw`flex-row items-center justify-between`}>
          ...
          <View>
            ...
            <Text style={tw`text-gray100 text-xs font-WorkRegular font-400`}>
              Current Subscription
            </Text>
          </View>
          <Text style={tw`text-[#000000] text-base font-WorkMedium font-500`}>
            $29.99/year
          </Text>
        </View>
        ...
        <Text style={tw`text-gray100 text-sm font-WorkRegular font-400 mt-4`}>
