          ...
          <View style={tw`mt-6 gap-y-4`}>
            <TouchableOpacity
              style={tw`flex-row items-center justify-between w-full px-4 ${
                subscription === 0
                  ? 'bg-radioBg border-violet100'
                  : 'bg-transparent border-gray90'
              } border  rounded-2xl h-16`}
              onPress={() => setSubscription(0)}>
              <View style={tw`flex-row items-center gap-3`}>
                <View
                  style={tw`border ${
                    subscription === 0 ? 'border-violet100' : 'border-gray90'
                  } rounded-full`}>
                  <View
                    style={tw`border-[6px] ${
                      subscription === 0
                ...
                <Text
                  style={tw`text-black text-[20px] font-WorkSemiBold font-600`}>
                  Monthly
                </Text>
              </View>
            ...
            <TouchableOpacity
              ...
              <View style={tw`flex-row items-center gap-3`}>
                <View
                  style={tw`border ${
                    subscription === 1 ? 'border-violet100' : 'border-gray90'
                  } rounded-full`}>
                  <View
                    style={tw`border-[6px] ${
                      subscription === 1
              ...
              <View
                style={tw`bg-violet100 rounded px-2 py-1 absolute top-[-3] right-7`}>
